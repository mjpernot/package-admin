...
class UnitTest(unittest.TestCase):
    ...
    Methods:
        setUp
        test_list_ins_pkg_file
        test_list_ins_pkg_file_json
        test_list_ins_pkg_sup_std
        test_list_ins_pkg_out_std
        tearDown
    ...
    def setUp(self):
        ...
        self.out_file = os.path.join(self.tmp_path, "package_ins_list.txt")
        self.dbn = "test_sysmon"
        self.tbl = "test_server_pkgs"
        self.array2 = ["-o", self.out_file, "-z"]
        ...
        self.args_array5.args_array["-z"] = True
    ...
    def test_list_ins_pkg_sup_std(self, mock_date):
        ...
        self.assertEqual(
            package_admin.list_ins_pkg(self.args_array4, self.yum),
            (True, None))
    ...
    def test_list_ins_pkg_out_std(self, mock_date):
        ...
        self.assertEqual(
            package_admin.list_ins_pkg(self.args_array5, self.yum),
            (True, None))
