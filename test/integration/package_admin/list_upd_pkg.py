...
class UnitTest(unittest.TestCase):
    ...
    Methods:
        ...
        test_list_upd_pkg_file -> Test writing to file.
        test_list_upd_pkg_file_json -> Test writing to file in JSON format.
        test_list_upd_pkg_sup_std -> Test suppressing standard out.
        test_list_upd_pkg_out_std -> Test writing to standard out.
        test_list_upd_pkg_mongo -> Test writing to Mongo database.
        test_list_upd_pkg_mongo_file -> Test writing to Mongo database & file.
    ...
    def setUp(self):
        ...
        self.out_file = os.path.join(self.out_path, "package_upd_list.txt")
        self.non_json_file = os.path.join(self.out_path,
                                          "package_upd_list_non_json")
        self.json_file = os.path.join(self.out_path, "package_upd_list_json")
    ...
    def test_list_upd_pkg_sup_std(self, mock_date):
        ...
        self.assertFalse(package_admin.list_upd_pkg(self.args_array4, self.yum,
                                                    class_cfg=self.mongo_cfg))
    ...
    def test_list_upd_pkg_out_std(self, mock_date):
        ...
        with gen_libs.no_std_out():
            self.assertFalse(package_admin.list_upd_pkg(
